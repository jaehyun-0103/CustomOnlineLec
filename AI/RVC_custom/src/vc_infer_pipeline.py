...
class VC(object):
    ...
    def get_f0_crepe_computation(
        ...
        f0_max,
        p_len,
        hop_length=160,  # 512 before. Hop length changes the speed that the video jumps to a different dramatic pitch. Lower hop lengths means more pitch accuracy but longer inference time.
